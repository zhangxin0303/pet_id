...
package com.cqcej.web.modules.job.service.impl;
...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
	...
	public void save(ScheduleJobEntity scheduleJob) {
		...
		scheduleJob.setStatus(AdminConstant.ScheduleStatus.NORMAL.getValue());
	...
	public void pause(Long[] jobIds) {
		...
		updateBatch(jobIds, AdminConstant.ScheduleStatus.PAUSE.getValue());
	}
	...
	public void resume(Long[] jobIds) {
		...
		updateBatch(jobIds, AdminConstant.ScheduleStatus.NORMAL.getValue());
	}
