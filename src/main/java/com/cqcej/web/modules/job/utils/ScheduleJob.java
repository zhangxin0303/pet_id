...
import com.cqcej.web.modules.job.entity.ScheduleJobLogEntity;
import com.cqcej.web.modules.job.service.ScheduleJobLogService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		if (obj instanceof String) {
			...
			scheduleJob = gson.fromJson((String) obj, ScheduleJobEntity.class);
		} else {
			throw new CTException("类型转换错误");
		}
