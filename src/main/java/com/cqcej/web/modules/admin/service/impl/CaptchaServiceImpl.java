...
import com.cqcej.web.modules.admin.dao.SysCaptchaDao;
import com.cqcej.web.modules.admin.entity.SysCaptchaEntity;
...
public class CaptchaServiceImpl extends ServiceImpl<SysCaptchaDao, SysCaptchaEntity> implements CaptchaService {
	@Autowired
	...
	public BufferedImage getCaptcha(String uuid) {
		if (StringUtils.isBlank(uuid)) {
			throw new CTException("uuid不能为空");
		}
		//生成文字验证码
		//String code = producer.createText();
		String code = "1111";// TODO 使用1111的验证码方便测试，上线时更改
